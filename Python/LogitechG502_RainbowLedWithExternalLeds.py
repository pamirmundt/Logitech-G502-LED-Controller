...
# This demo displays HSV rainbow colors on DPI and Logo LEDs and external RGB led attached to RPi3 gpios
# Red 	- GPIO 17
# Green	- GPIO 27
# Blue 	- GPIO 22
...
def dpiColor(R,G,B):
    ...
    # Clear mouse buffer if an event occurs
    getMouseEvent()
...
def runForever():
    ...
    # Be sure that every color is displayed in equal duration
    if delta >= 0:
        time.sleep(delta)
